...
<head>
    ...
    <link rel="stylesheet" href="{{ asset($theme.'css/morris.css')}}" type="text/css"/>
    <!-- Graph CSS -->
    ...
    <!-- lined-icons -->
    <link rel="stylesheet" href="{{ asset($theme.'css/icon-font.min.css')}}" type='text/css' />

    <link rel="stylesheet" type="text/css" href="{{ asset($theme.'plugins/noty/css/noty.css') }}">

    <!-- tables -->
    <link rel="stylesheet" type="text/css" href="{{ asset($theme.'css/table-style.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ asset($theme.'css/basictable.css') }}" />
    <script type="text/javascript" src="{{ asset($theme.'js/jquery.basictable.min.js') }}"></script>
...
<div class="copyrights">
     <p>&copy; {{date('Y')}} Pooled. All Rights Reserved | Developed by  <a href="http://w3layouts.com/" target="_blank">W3layouts</a> </p>
</div>  
                ...
                <div class="sidebar-menu">
                    <header class="logo1">
                        ...
                        <div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
                                    <ul id="menu" >
                                        <li><a href="{{url('/')}}"><i class="fa fa-tachometer"></i> <span>Dashboard</span><div class="clearfix"></div></a></li>
                                        <li>
                                            <a href="javascript:;">
